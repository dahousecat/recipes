...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(6), __webpack_require__(75)))
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ImagePreview_vue__ = __webpack_require__(50);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__helpers_misc__ = __webpack_require__(91);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        updatNutrition: function updatNutrition() {
            ...
            for (var i = 0; i < this.rows.length; i++) {
                ...
                if (row.unit_id !== row.unit.id) {
                    ...
                    row.unit = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__helpers_misc__["b" /* getUnit */])(row.unit_id, this.units);
                }

                this.setRowWeight(row);
                totalWeight += parseInt(row.weight);

                for (var nutrientName in row.ingredient.nutrients) {
                    if (row.ingredient.nutrients.hasOwnProperty(nutrientName)) {
                        var nutrient = row.ingredient.nutrients[nutrientName];
            ...
            for (var _nutrientName in nutrients) {
                if (nutrients.hasOwnProperty(_nutrientName)) {
                    var _nutrient = nutrients[_nutrientName];

                    if (this.amountPer === 'recipe') {
                        _nutrient.value = _nutrient.per_100_g / 100 * totalWeight;
                    } else {
                        _nutrient.value = _nutrient.per_100_g / 100 * parseInt(this.amountPer);
                    }

                    if (_nutrientName === 'energy') {
                        // Convert to display unit
                        var conversionFactor = this.energyUnit === 'calorie' ? 1 : this.conversions.caloriesInKj;
                        _nutrient.value = _nutrient.value / conversionFactor;
                    }

                    _nutrient.displayValue = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__helpers_misc__["c" /* formatNumber */])(_nutrient.value);
                }
            }
        ...
        recalculateEnergy: function recalculateEnergy() {
            var energy = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__helpers_misc__["d" /* convertEnergyUnit */])(this.nutrients.energy.value, this.energyUnit);
            this.nutrients.energy.value = energy;
            this.nutrients.energy.displayValue = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__helpers_misc__["c" /* formatNumber */])(energy);
        }
    }
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__helpers_flash__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__helpers_api__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__helpers_misc__ = __webpack_require__(91);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__helpers_form__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_Modal_vue__ = __webpack_require__(89);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        Modal: __WEBPACK_IMPORTED_MODULE_5__components_Modal_vue___default.a
    },
    data: function data() {
        return {
            form: {
    ...
    created: function created() {
        ...
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__helpers_api__["b" /* get */])(this.initializeURL).then(function (res) {
            ...
            __WEBPACK_IMPORTED_MODULE_0_vue___default.a.set(_this.$data, 'units', res.data.units);
            __WEBPACK_IMPORTED_MODULE_0_vue___default.a.set(_this.$data, 'attributeTypes', res.data.attributeTypes);
        });
    },

    methods: {
        getWeightUrl: function getWeightUrl() {
            return 'https://www.google.com.au/search?q=how+much+does+one+' + this.form.name + '+weight?';
        },
        ...
        searchNdb: function searchNdb() {
            ...
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__helpers_misc__["a" /* loading */])(true);
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__helpers_api__["b" /* get */])('/api/ndb/search/' + this.form.name).then(function (res) {
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__helpers_misc__["a" /* loading */])(false);
        ...
        selectNdbIngredient: function selectNdbIngredient(item) {
            ...
            this.ndb.groups = {};
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__helpers_misc__["a" /* loading */])(true, 'nutrients-panel');
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__helpers_api__["b" /* get */])('/api/ndb/view/' + item.id).then(function (res) {
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__helpers_misc__["a" /* loading */])(false, 'nutrients-panel');
                for (var i = 0; i < res.data.length; i++) {
                    var row = res.data[i];
                    _this3.form.nutrients[row.attribute_safe_name].value = row.value;
                }
            }).catch(function (error) {
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__helpers_misc__["a" /* loading */])(false);
                console.log(error);
        ...
        getSearchUrl: function getSearchUrl(type) {
            var attribute = type.name === 'energy' ? this.energyUnit : type.name;
            return 'https://www.google.com.au/search?q=how+many+' + attribute + '+are+there+in+100g+of+' + this.form.name;
        },
        ...
        save: function save() {
            ...
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__helpers_misc__["a" /* loading */])(true);
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__helpers_api__["a" /* post */])(this.storeURL, this.form).then(function (res) {
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__helpers_misc__["a" /* loading */])(false);
                __WEBPACK_IMPORTED_MODULE_1__helpers_flash__["a" /* default */].setSuccess('Ingredient saved.');
            }).catch(function (err) {
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__helpers_misc__["a" /* loading */])(false);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        convertIngredientFormEnergyUnit: function convertIngredientFormEnergyUnit() {
            this.energyExactValue = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__helpers_misc__["d" /* convertEnergyUnit */])(this.energyExactValue, this.energyUnit);
        ...
        save: function save() {
            ...
            // Set units
            for (var x = 0; x < this.ingredient.units.length; x++) {
                var ingredientUnitType = this.ingredient.units[x].unitType;
        ...
        updateDefaultUnitOptions: function updateDefaultUnitOptions() {
            this.default_unit_options = [];
            for (var i = 0; i < this.ingredient.units.length; i++) {
                var unit = this.ingredient.units[i];
                if (this.ingredient[unit.unitType]) {
                    var name = unit.name == 'whole' ? 'quantity' : unit.name;
        ...
        //                }
        //            },
        getAttributeType: function getAttributeType(safe_name) {
            for (var i = 0; i < this.attribute_types.length; i++) {
                var attributeType = this.attribute_types[i];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__helpers_misc__ = __webpack_require__(91);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__helpers_form__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_ImageUpload_vue__ = __webpack_require__(51);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_vuedraggable__ = __webpack_require__(74);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Ingredient_IngredientForm_vue__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Ingredient_IngredientForm_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__Ingredient_IngredientForm_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_Nutrients_vue__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_Nutrients_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8__components_Nutrients_vue__);
//
//
//
//
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_6_vuedraggable___default.a);
...
/* harmony default export */ __webpack_exports__["default"] = ({
	components: {
		...
		ingredientForm: __WEBPACK_IMPORTED_MODULE_7__Ingredient_IngredientForm_vue___default.a,
		Nutrients: __WEBPACK_IMPORTED_MODULE_8__components_Nutrients_vue___default.a
	},
	data: function data() {
		return {
			form: {
	...
	watch: {
		...
		ingredient: function ingredient(str) {
			...
			__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__helpers_api__["b" /* get */])(url).then(function (res) {
				__WEBPACK_IMPORTED_MODULE_0_vue___default.a.set(_this2.$data, 'ingredients', _this2.rowify(res.data.ingredients));
			});
		}
	},
	...
	created: function created() {
		...
		__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__helpers_api__["b" /* get */])(this.initializeURL).then(function (res) {
			...
			__WEBPACK_IMPORTED_MODULE_0_vue___default.a.set(_this3.$data, 'units', res.data.units);
			__WEBPACK_IMPORTED_MODULE_0_vue___default.a.set(_this3.$data, 'attributeTypes', res.data.attributeTypes);
			...
			var items = []; // I will call a row / ingredient and "item"
			for (var i = 0; i < res.data.ingredients.length; i++) {
				var ingredient = res.data.ingredients[i];
				...
				items.push({
					...
					unit: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__helpers_misc__["b" /* getUnit */])(ingredient.default_unit_id, _this3.units),
					value: 1
				});
			}
			__WEBPACK_IMPORTED_MODULE_0_vue___default.a.set(_this3.$data, 'ingredients', items);
		});
	},
	...
	methods: {
		...
		dragEnd: function dragEnd(evt) {
			...
			var item = this.editIngredient.length === 1 ? this.editIngredient[0] : this.form.rows[evt.newIndex];
			var _this = this;
		...
		setIngredientNutrients: function setIngredientNutrients(item) {
			return new Promise(function (resolve, reject) {
		...
		rowify: function rowify(ingredients) {
			var rows = [];
		...
		setUnitsArray: function setUnitsArray(rowIngredient) {
			rowIngredient.units = [];
			for (var i = 0; i < rowIngredient.ingredient.relationships.units.data.length; i++) {
				var id = rowIngredient.ingredient.relationships.units.data[i].id;
		...
		setNutrients: function setNutrients(ingredient) {
			return new Promise(function (resolve, reject) {
				if (typeof ingredient.nutrients === 'undefined') {
					...
					__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__helpers_api__["b" /* get */])('/api/ingredient/' + ingredient.ingredient.id + '/attributes').then(function (res) {
			...
			return new Promise(function (resolve, reject) {
				if (_this.attributeTypes.length) {
					...
					__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__helpers_api__["b" /* get */])('/api/attribute-types').then(function (res) {
						__WEBPACK_IMPORTED_MODULE_0_vue___default.a.set(_this.$data, 'attributeTypes', res.data.data);
						resolve();
					}).catch(function (error) {
						console.log(error);
						reject();
		...
		updateNutrition: function updateNutrition() {
			...
			for (var nutritionType in this.nutrients) {
				if (this.nutrients.hasOwnProperty(nutritionType)) {
					...
					nutrition.displayValue = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__helpers_misc__["c" /* formatNumber */])(nutrition.exactValue);
				}
			}
		...
		save: function save() {
			...
			__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__helpers_api__["a" /* post */])(this.storeURL, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__helpers_form__["a" /* objectToFormData */])(data)).then(function (res) {
				if (res.data.saved) {
		...
		ingredientSaved: function ingredientSaved() {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__views_Auth_Login_vue__ = __webpack_require__(53);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__views_Auth_Register_vue__ = __webpack_require__(54);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__views_Recipe_Index_vue__ = __webpack_require__(59);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__views_Recipe_Show_vue__ = __webpack_require__(60);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__views_Recipe_Form_vue__ = __webpack_require__(58);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__views_Ingredient_Index_vue__ = __webpack_require__(92);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__views_Ingredient_Index_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__views_Ingredient_Index_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__views_Ingredient_Form_vue__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__views_Ingredient_Form_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8__views_Ingredient_Form_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__views_NotFound_vue__ = __webpack_require__(57);
...
var router = new __WEBPACK_IMPORTED_MODULE_1_vue_router__["a" /* default */]({
	mode: 'history',
	routes: [{ path: '/', component: __WEBPACK_IMPORTED_MODULE_4__views_Recipe_Index_vue___default.a }, { path: '/recipes/create', component: __WEBPACK_IMPORTED_MODULE_6__views_Recipe_Form_vue___default.a, meta: { mode: 'create' } }, { path: '/recipes/:id/edit', component: __WEBPACK_IMPORTED_MODULE_6__views_Recipe_Form_vue___default.a, meta: { mode: 'edit' } }, { path: '/recipes/:id', component: __WEBPACK_IMPORTED_MODULE_5__views_Recipe_Show_vue___default.a }, { path: '/ingredients', component: __WEBPACK_IMPORTED_MODULE_7__views_Ingredient_Index_vue___default.a }, { path: '/ingredients/create', component: __WEBPACK_IMPORTED_MODULE_8__views_Ingredient_Form_vue___default.a, meta: { mode: 'create' } }, { path: '/ingredients/:id/edit', component: __WEBPACK_IMPORTED_MODULE_8__views_Ingredient_Form_vue___default.a, meta: { mode: 'edit' } }, { path: '/register', component: __WEBPACK_IMPORTED_MODULE_3__views_Auth_Register_vue___default.a }, { path: '/login', component: __WEBPACK_IMPORTED_MODULE_2__views_Auth_Login_vue___default.a }, { path: '/not-found', component: __WEBPACK_IMPORTED_MODULE_9__views_NotFound_vue___default.a }, { path: '*', component: __WEBPACK_IMPORTED_MODULE_9__views_NotFound_vue___default.a }]
});
...
Component.options.__file = "C:\\Users\\dahou\\PhpstormProjects\\recipes\\resources\\assets\\js\\App.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-52a97bd5", Component.options)
  } else {
    hotAPI.reload("data-v-52a97bd5", Component.options)
  }
})()}
...
Component.options.__file = "C:\\Users\\dahou\\PhpstormProjects\\recipes\\resources\\assets\\js\\components\\ImagePreview.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7657348c", Component.options)
  } else {
    hotAPI.reload("data-v-7657348c", Component.options)
  }
})()}
...
Component.options.__file = "C:\\Users\\dahou\\PhpstormProjects\\recipes\\resources\\assets\\js\\components\\ImageUpload.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5e05dd02", Component.options)
  } else {
    hotAPI.reload("data-v-5e05dd02", Component.options)
  }
})()}
...
Component.options.__file = "C:\\Users\\dahou\\PhpstormProjects\\recipes\\resources\\assets\\js\\components\\Nutrients.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] Nutrients.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-364cb26f", Component.options)
  } else {
    hotAPI.reload("data-v-364cb26f", Component.options)
  }
})()}
...
Component.options.__file = "C:\\Users\\dahou\\PhpstormProjects\\recipes\\resources\\assets\\js\\views\\Auth\\Login.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-542aa15f", Component.options)
  } else {
    hotAPI.reload("data-v-542aa15f", Component.options)
  }
})()}
...
Component.options.__file = "C:\\Users\\dahou\\PhpstormProjects\\recipes\\resources\\assets\\js\\views\\Auth\\Register.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4b42071d", Component.options)
  } else {
    hotAPI.reload("data-v-4b42071d", Component.options)
  }
})()}
...
Component.options.__file = "C:\\Users\\dahou\\PhpstormProjects\\recipes\\resources\\assets\\js\\views\\Ingredient\\Form.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-22de0116", Component.options)
  } else {
    hotAPI.reload("data-v-22de0116", Component.options)
  }
})()}
...
Component.options.__file = "C:\\Users\\dahou\\PhpstormProjects\\recipes\\resources\\assets\\js\\views\\NotFound.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-067b4728", Component.options)
  } else {
    hotAPI.reload("data-v-067b4728", Component.options)
  }
})()}
...
Component.options.__file = "C:\\Users\\dahou\\PhpstormProjects\\recipes\\resources\\assets\\js\\views\\Recipe\\Form.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] Form.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-90f01450", Component.options)
  } else {
    hotAPI.reload("data-v-90f01450", Component.options)
  }
})()}
...
Component.options.__file = "C:\\Users\\dahou\\PhpstormProjects\\recipes\\resources\\assets\\js\\views\\Recipe\\Index.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-bfd20d24", Component.options)
  } else {
    hotAPI.reload("data-v-bfd20d24", Component.options)
  }
})()}
...
Component.options.__file = "C:\\Users\\dahou\\PhpstormProjects\\recipes\\resources\\assets\\js\\views\\Recipe\\Show.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-f1cc00de", Component.options)
  } else {
    hotAPI.reload("data-v-f1cc00de", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-067b4728", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v("Ingredient form")]), _vm._v(" "), _c('div', {
  ...
  }, [_vm._v("Cancel")])]), _vm._v(" "), _c('fieldset', [_c('div', {
    staticClass: "row equal-height"
  }, [_c('div', {
    staticClass: "col-s-4 form__panel"
  }, [_c('div', {}, [_c('div', {
  ...
  }, [_vm._v(_vm._s(_vm.error.name[0]))]) : _vm._e()]), _vm._v(" "), (typeof _vm.form.units.quantity !== 'undefined') ? _c('div', {
    staticClass: "form__group"
  }, [_c('label', [_vm._v("\n                            How much does one " + _vm._s(_vm.form.name) + " weight? (grams)\n                            "), (_vm.form.name) ? _c('a', {
    attrs: {
    ...
    staticClass: "error__control"
  }, [_vm._v(_vm._s(_vm.error.weight[0]))]) : _vm._e()]) : _vm._e()])]), _vm._v(" "), _c('div', {
    staticClass: "col-s-4 form__panel"
  }, [_c('div', {}, [_c('div', {
    staticClass: "form__title"
  }, [_vm._v("Would you measure " + _vm._s(_vm.form.name) + " using...")]), _vm._v(" "), _vm._l((_vm.unitTypes), function(unitType, unitTypeName) {
    return _c('div', {
      staticClass: "row"
    }, [_c('div', {
      staticClass: "col-s-1"
      ...
      directives: [{
        name: "model",
        rawName: "v-model",
        value: (unitType.checked),
        expression: "unitType.checked"
      }],
      staticClass: "form__control",
      attrs: {
        "id": unitTypeName,
      ...
      domProps: {
        "checked": Array.isArray(unitType.checked) ? _vm._i(unitType.checked, null) > -1 : (unitType.checked)
      },
      on: {
        ...
        "__c": function($event) {
          ...
          if (Array.isArray($$a)) {
            var $$v = null,
              $$i = _vm._i($$a, $$v);
            if ($$c) {
              $$i < 0 && (unitType.checked = $$a.concat($$v))
            } else {
              $$i > -1 && (unitType.checked = $$a.slice(0, $$i).concat($$a.slice($$i + 1)))
            }
          } else {
            unitType.checked = $$c
          }
      ...
      staticClass: "col-s-11"
    }, [_c('label', {
      attrs: {
        "for": unitTypeName
      }
    }, [_vm._v(_vm._s(unitType.label))])])])
  }), _vm._v(" "), _c('div', {
    staticClass: "row"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.form.default_unit_id),
      expression: "form.default_unit_id"
    }],
    staticClass: "form__control",
    attrs: {
      "type": "text"
    ...
    on: {
      "change": function($event) {
        ...
        _vm.form.default_unit_id = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
      }
    }
  }, _vm._l((_vm.form.units), function(unit, index) {
    return _c('option', {
      domProps: {
        "value": unit.id
      }
    ...
    attrs: {
      "disabled": _vm.form.name.length ? false : true
    },
    on: {
      "click": function($event) {
        _vm.searchNdb()
  ...
  }, [_vm._v("Autofill")]), _vm._v(" "), _vm._l((_vm.attributeTypes), function(type, index) {
    return _c('div', {
      staticClass: "row"
    }, [_c('div', {
      staticClass: "col-s-6"
    }, [_c('label', [_vm._v("\n                                " + _vm._s(_vm.capitalize(type.name)) + " (" + _vm._s(type.unit) + ")\n                                "), _c('a', {
      attrs: {
      ...
      directives: [{
        name: "model",
        rawName: "v-model",
        value: (_vm.form.nutrients[type.safe_name].value),
        expression: "form.nutrients[type.safe_name].value"
      }],
      staticClass: "form__control",
      attrs: {
        "type": "text"
      ...
      on: {
        "input": function($event) {
          if ($event.target.composing) { return; }
          _vm.form.nutrients[type.safe_name].value = $event.target.value
        }
      }
    })])])
  })], 2)])])]), _vm._v(" "), _c('modal', {
    attrs: {
      "show": !!Object.keys(_vm.ndb.groups).length
    },
    on: {
    ...
    slot: "title"
  }, [_vm._v("Select the closest match")]), _vm._v(" "), _c('ul', {
  ...
  return _c('div', {
    staticClass: "col-s-6"
  }, [_c('label', [_vm._v("Default unit id")])])
}]}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-22de0116", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "nutrients",
    class: [_vm.updating ? 'loading' : '']
  }, [_c('div', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-364cb26f", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-4b42071d", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("Smoothie Recipes")]), _vm._v(" "), _c('nav', {
  ...
  }, [_vm._v("Create recipe")])], 1) : _vm._e(), _vm._v(" "), _c('li', {
    staticClass: "navigation__item"
  }, [_c('router-link', {
    staticClass: "navigation__link",
    attrs: {
  ...
  }, [_vm._v("Ingredients")])], 1), _vm._v(" "), (_vm.auth) ? _c('li', {
    staticClass: "navigation__item"
  }, [_c('router-link', {
    staticClass: "navigation__link",
    attrs: {
  ...
  }, [_vm._v("Create ingredient")])], 1) : _vm._e(), _vm._v(" "), (_vm.auth) ? _c('li', {
    staticClass: "navigation__item"
  }, [_c('a', {
    staticClass: "navigation__link",
    on: {
  ...
  return _c('button', {
    ...
    staticClass: "fa fa-bars navigation__bars",
    attrs: {
      "aria-hidden": "true"
    }
  })])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-52a97bd5", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-542aa15f", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-5e05dd02", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-7657348c", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return _c('div', {
      ...
      on: {
        "change": [function($event) {
          ...
          row.unit_id = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
        }, function($event) {
          _vm.recalculateNutrition = true
        }]
      }
    }, _vm._l((row.ingredient.units), function(unit, index) {
      return _c('option', {
        domProps: {
          "value": unit.unit_id
        }
    ...
    attrs: {
      "rows": _vm.form.rows,
      "units": _vm.units,
      "recalculate": _vm.recalculateNutrition
    },
    on: {
      "nutritionUpdated": function($event) {
        _vm.recalculateNutrition = false
      }
    }
  }), _vm._v(" "), _c('div', {
  ...
  }, [_vm._v("Add Direction")])], 2)])], 1), _vm._v(" "), _c('draggable', {
    ...
    attrs: {
      ...
      "attributeTypes": _vm.attributeTypes,
      "units": this.units
    },
    on: {
      "close": function($event) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-90f01450", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-bfd20d24", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('transition', {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.ingredient.attributes.weight),
      expression: "ingredient.attributes.weight"
    }],
    staticClass: "form__control",
    attrs: {
      "type": "text"
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.ingredient.attributes.weight = $event.target.value
      }
    }
  }), _vm._v(" "), (_vm.error.weight) ? _c('small', {
    staticClass: "error__control"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.ingredient.attributes.default_unit_id),
      expression: "ingredient.attributes.default_unit_id"
    }],
    staticClass: "form__control",
    attrs: {
      "type": "text"
    ...
    on: {
      "change": function($event) {
        ...
        _vm.ingredient.attributes.default_unit_id = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
      }
    }
  }, _vm._l((_vm.default_unit_options), function(unit, index) {
    return _c('option', {
      domProps: {
        "value": unit.id
      }
    ...
    return _c('div', {
      ...
      staticClass: "form__group form__group--inline"
    }, [(type.attributes.name === 'energy') ? _c('label', [_vm._v("\n                                    Energy\n                                    "), _c('a', {
      attrs: {
        "href": _vm.getSearchUrl(type),
        "target": "_blank"
      }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "recipe__sub_title"
  }, [_vm._v("Ingredients")]), _vm._v(" "), _c('ul', _vm._l((_vm.recipe.rows), function(row) {
    return _c('li', [_c('span', [_vm._v(_vm._s(row.ingredient.name))]), _vm._v(" "), _c('span', [_vm._v(_vm._s(row.unit_value))]), _vm._v(" "), _c('span', [_vm._v(_vm._s(row.unit.name))])])
  }))])]), _vm._v(" "), _c('div', {
    staticClass: "recipe__directions"
  }, [_c('div', {
    staticClass: "recipe__directions_inner"
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-f1cc00de", module.exports)
  }
}
...
Component.options.__file = "C:\\Users\\dahou\\PhpstormProjects\\recipes\\resources\\assets\\js\\components\\Modal.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-070554b0", Component.options)
  } else {
    hotAPI.reload("data-v-070554b0", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return (_vm.show) ? _c('div', {
    staticClass: "modal-overlay fade-out fade-in",
    attrs: {
      "role": "document",
      "aria-labelledby": _vm.labelId
    }
  }, [_c('div', {
    staticClass: "modal fade-out fade-in",
    attrs: {
      "tabindex": "0"
    }
  }, [_c('div', {
    ...
    staticClass: "modal-header fade-out fade-in"
  }, [_c('div', {
    staticClass: "container"
  }, [_vm._t("title", null, {
    id: _vm.labelId
  })], 2)]), _vm._v(" "), _c('button', {
    staticClass: "modal-close fade-out fade-in",
    attrs: {
      "type": "button"
    },
    on: {
  ...
  }, [_vm._v("Close (Esc)")])]), _vm._v(" "), _c('div', {
    staticClass: "modal-footer fade-out fade-in"
  }, [_c('div', {
    staticClass: "container"
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-070554b0", module.exports)
  }
}
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["d"] = convertEnergyUnit;
/* harmony export (immutable) */ __webpack_exports__["c"] = formatNumber;
/* harmony export (immutable) */ __webpack_exports__["b"] = getUnit;
/* harmony export (immutable) */ __webpack_exports__["a"] = loading;
function convertEnergyUnit(old_value, new_unit) {
    var new_value = void 0;
    var caloriesInKj = 0.239006;
    if (new_unit === 'calorie') {
...
function loading(val) {
    var id = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'overlay';
...
Component.options.__file = "C:\\Users\\dahou\\PhpstormProjects\\recipes\\resources\\assets\\js\\views\\Ingredient\\Index.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] Index.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4a2f2371", Component.options)
  } else {
    hotAPI.reload("data-v-4a2f2371", Component.options)
  }
})()}
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__helpers_api__["b" /* get */])('/api/ingredients').then(function (res) {
            _this.ingredients = res.data.ingredients;
        });
    }
});
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "ingredient__list"
  }, _vm._l((_vm.ingredients), function(ingredient) {
    return _c('div', {
      staticClass: "ingredient__item"
    }, [_c('router-link', {
      staticClass: "ingredient__inner",
      attrs: {
        "to": ("/ingredients/" + (ingredient.id) + "/edit")
      }
    }, [_c('p', {
      staticClass: "ingredient__name"
    }, [_vm._v(_vm._s(ingredient.name))])])], 1)
  }))
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-4a2f2371", module.exports)
  }
}
